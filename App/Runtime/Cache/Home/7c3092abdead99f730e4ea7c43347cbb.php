...
<head>
    ...
    <link rel="stylesheet" href="/Public/home/css/zhufu.css">
	<link rel="stylesheet" href="/Public/home/css/footer.css">
	<script src="/Public/home/js/jquery.js"></script>

	<script src="/Public/home/js/zhifu.js"></script>
</head>
<body>
<div class="top_box">
    <div class="top_cont">
...
<div class="top_logob">
    <img src="/Public/home/img/pic-15.jpg" class="top_logob_imga">
    <img src="/Public/home/img/pic-16.jpg" class="top_logob_imgb">
</div>
    ...
    <li><label><span>* </span>手机：</label>
    	...
    	<button id="submitbtn-SH" >保存收货人信息</button>
            ...
            <div style="cursor:pointer;" class="box-ax bgse pink"  id="bgdiv0" value="0"> <p>
             ...
             <img src="/Public/home/img/pic-07.jpg" id="icon"> </div>
...
<span class="jiao2" style="display: none;">
 ...
 <img class="title_img" 
 onmouseover="title_imgShow(this)" onmouseout="title_imgHide(this)" src="/Public/home/img/title.png"></b></p><p class="list-c">29.90</p><p class="list-d">1</p><p class="list-e">29.90</p></div></div>
...
<div style="text-align:right;" id="agree_condition">
    ...
    <p id="submitbutton" style="margin-bottom: 15px;"><a href="<?php echo U('Orders/money');?>"><button style="font-size: 18px;cursor: pointer;margin-top: 2px;">提交订单</button></a></p>
</div>
