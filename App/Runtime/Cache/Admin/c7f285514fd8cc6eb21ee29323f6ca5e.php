...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="<?php echo U('statu_add');?>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> 添加订单状态</a>
		
		<p class="pull-right tots" >共有 <?php echo count($data);?> 条数据</p>
