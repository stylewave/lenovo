...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="<?php echo U('lunbo_add');?>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> 添加轮播图</a>
	...
	<table class="table-bordered table table-hover">
		...
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><input type="text" name="" onblur="sorts(this,<?php echo ($admin[id]); ?>)" id="" value="<?php echo ($admin[sort]); ?>"></td>
			<td><img src="/lenovo/Uploads/Lunbo/sm_<?php echo ($admin['img']); ?>" alt=""></td>
