...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="<?php echo U('add');?>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> 添加广告</a>
	...
	<table class="table-bordered table table-hover">
		...
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><img height="200px" src="/Uploads/Ads/<?php echo ($admin[img]); ?>" alt=""></td>
