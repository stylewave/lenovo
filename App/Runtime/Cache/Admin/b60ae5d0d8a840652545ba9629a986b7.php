...
<div class="panel panel-default">
	<div class="panel-heading">
		<a href="index.html" class="btn btn-danger">订单状态修改页面</a>
	...
	<div class="panel-body">
		<form action="<?php echo U('edit');?>" method="post">
			<div class="form-group">
				...
				<select name="sid" class="form-control" id="">
					<?php if(is_array($statu)): $i = 0; $__LIST__ = $statu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ss): $mod = ($i % 2 );++$i; if ($data['sid']==$ss['id']) { echo '<option selected value="'.$ss[id].'">'.$ss[name].'</option>'; }else{ echo '<option  value="'.$ss[id].'">'.$ss[name].'</option>'; }; endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
