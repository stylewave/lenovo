...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="<?php echo U('add');?>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> 添加商品</a>
	...
	<table class="table-bordered table table-hover">
		...
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('info',array('id'=>$admin[id]));?>"><?php echo ($admin[name]); ?></a></td>
			<td style="width:150px"><?php echo ($admin[info]); ?></td>
			<td><img src="/Uploads/Goods/sm_<?php echo ($admin['img']); ?>" alt=""></td>
			<td><?php echo ($admin[price]); ?></td>
			<td><?php echo ($admin[num]); ?></td>
			<?php switch($admin[type]): case "0": ?><td>其他</td><?php break;?>
				<?php case "1": ?><td>新品</td><?php break;?>
				<?php case "2": ?><td>直降</td><?php break;?>
				<?php case "3": ?><td>热卖</td><?php break;?>
				<?php case "4": ?><td>爆款</td><?php break; endswitch;?>
