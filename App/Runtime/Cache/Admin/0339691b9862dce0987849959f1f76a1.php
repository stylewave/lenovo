...
<div class="panel panel-default">
	<div class="panel-heading">
		<a href="index.html" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> 品牌页面</a>
		<a href="" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> 添加品牌</a>
...
<script>
		...
		$('#ups').uploadify({
	    	...
	    	'uploader' : '<?php echo U("Brand/ajax_up");?>',   //上传的方法
	    	'buttonText' : '商品图片上传',
	    	onUploadSuccess : function(file, data, response) {
				//把所有上传的图片都放入DIV中
				$("#img_post").val(data);
				img = "<img width='200px' src='/lenovo/Uploads/Brand/"+data+"'>";
				$('#imgs').html(img);
			}
		});
</script>
