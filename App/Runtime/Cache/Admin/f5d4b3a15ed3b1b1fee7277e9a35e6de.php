...
<!-- 面版 -->
	<form action="" method="post">
		<div class="form-group">
			...
			<input type="text" name="TITLE" value="<?php echo C('TITLE');?>" class="form-control" id="">
		</div>
		<div class="form-group">
			<label for="">KEYWORDS</label>
			<input type="text" name="KEYWORDS" value="<?php echo C('KEYWORDS');?>" class="form-control" id="">
		</div>
		<div class="form-group">
			<label for="">DESCRIPT</label>
			<input type="text" name="DESCRIPT" value="<?php echo C('DESCRIPT');?>" class="form-control" id="">
		</div>
		<div class="form-group">
			<label for="">LOGO</label>
			<br>
			
			<div id="imgs"><img src="/lenovo/Uploads/<?php echo C('LOGO');?>" alt=""></div>
			<input type="file" name="img" class="form-control" id="ups">

			<input type="hidden" name="LOGO" value="<?php echo C('LOGO');?>" id="img_post">
			<input type="hidden" name="oldlogo" value="<?php echo C('LOGO');?>">
		</div>
		<div class="form-group">
			<label for="">BANQUAN</label>
			<input type="text" name="BANQUAN" value="<?php echo C('BANQUAN');?>" class="form-control" id="">
		</div>
		<div class="form-group">
...
<script>
		...
		$('#ups').uploadify({
	    	...
	    	'uploader' : '<?php echo U("Sys/ajax_ups");?>',   //上传的方法
	    	'buttonText' : '商品图片上传',
	    	onUploadSuccess : function(file, data, response) {
				//把所有上传的图片都放入DIV中
				$("#img_post").val(data);
				img = "<img width='200px' src='/lenovo/Uploads/"+data+"'>";
				$('#imgs').html(img);
			}
		});
</script>
