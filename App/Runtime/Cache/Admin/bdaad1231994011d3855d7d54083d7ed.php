...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="<?php echo U('add');?>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> 添加订单</a>
	...
	<table class="table-bordered table table-hover">
		...
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('order_list',array('code'=>$admin['code']));?>"><?php echo ($admin['code']); ?></a></td>
			<td><?php echo ($admin['uname']); ?></td>
			<td><?php echo date('Y-m-d H:i:s',$admin['time']);?></td>
			<td><a href="<?php echo U('orders_addr',array('id'=>$admin['aid']));?>">收货地址	</a></td>
			<td><?php echo ($admin['sname']); ?></td>
			<td><a href="<?php echo U('edit',array('code'=>$admin['code']));?>" class="glyphicon glyphicon-pencil"></a></td>
